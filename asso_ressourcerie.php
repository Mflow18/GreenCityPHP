...
<body>
 ...
 <div class="ensemble_menu" id="accueil">
  ...
  <section id="ressourcerie1.html">
    <h1 class="titrepage1">La ressourcerie</h1>
    <h2>Informations</h2>
    <div class="containerActAsso">
      <div class="imageActAsso">
        <img src="image/ressourcerie.jpg" height="300" width="300"alt="logo ressourcerie" class="imageActAsso1">
      </div>
